...
*/
MOCKABLE_FUNCTION(, IOTHUB_MESSAGING_RESULT, IoTHubMessageMonitoring_Open, IOTHUB_MESSAGE_MONITORING_HANDLE, messagingClientHandle, const char*, consumerGroup, size_t, partitionNumber, IOTHUB_MESSAGE_FILTER*, filter, IOTHUB_MESSAGE_MONITORING_STATE_CHANGED_CALLBACK, stateChangedCallback, void*, userContext);
...
*/
MOCKABLE_FUNCTION(, IOTHUB_MESSAGING_RESULT, IoTHubMessageMonitoring_SetMessageCallback, IOTHUB_MESSAGE_MONITORING_HANDLE, messagingClientHandle, IOTHUB_MESSAGE_RECEIVED_CALLBACK, messageReceivedCallback, void*, userContextCallback);
